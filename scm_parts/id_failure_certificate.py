...
"""Step 68 failure-certificate authority layer for CausalGate SCM-ID.
...
def failure_certificate_for_query(
    ...
    *,
    ...
    if hedge.formal_hedge_certified:
        ...
        reason = (source_reason_codes + ";" if source_reason_codes else "") + "FORMAL_HEDGE_CERTIFIED_STEP68" + (";" + hedge.hedge_reason_codes if hedge.hedge_reason_codes else "")
