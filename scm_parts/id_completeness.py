...
"""Canonical completeness-gate cases for CausalGate's SCM ID layer.

This module is intentionally small and deterministic.  It does not claim that
CausalGate implements full Shpitser/Pearl ID; it defines the regression matrix that
...
def run_id_completeness_matrix(cases: Iterable[IDCompletenessCase] | None = None) -> Dict[str, object]:
    ...
    return {
        ...
        "full_id_claim_reason": "Step 94 allows the global claim only after the controlled promotion gate is green; this historical matrix remains one prerequisite surface.",
