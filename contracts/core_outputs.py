"""Helpers that make CausalGate's user-facing output contract explicit.
...
def _write_core_manifest(out: Path, paths: Dict[str, str]) -> str:
    manifest = {
        "contract_version": 2,
        "meaning": "Stable public review outputs for causalgate run. Detailed debug artifacts remain in subdirectories.",
