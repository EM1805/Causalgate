...
class CounterfactualEngine:
    """Lightweight action-alternative comparator for CausalGate.
...
def main(argv: Optional[list[str]] = None) -> int:
    parser = argparse.ArgumentParser(description="Run CausalGate CounterfactualEngine adapter on one query JSON.")
