...
from causalgate.contracts import ActionPackage, DecisionPackage, normalize_action_package
...
class OperationalBrain:
    """Online orchestrator for CausalGate.
...
def main(argv: Optional[list[str]] = None) -> int:
    parser = argparse.ArgumentParser(description="Run CausalGate Operational Brain over candidate actions.")
