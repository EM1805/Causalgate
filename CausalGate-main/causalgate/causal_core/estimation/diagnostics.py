...
def run_synthetic_demo_diagnostics(payload: Mapping[str, Any] | None = None) -> EstimationDiagnosticsResult:
    ...
    return EstimationDiagnosticsResult(
        ...
        synthetic_data_summary={"rows": len(rows), "seed": seed, "columns": ["X", "Y", "Z", "N", "FutureX"], "generator": "causalgate.causal_core.estimation.diagnostics.generate_synthetic_backdoor_rows", "variable_mapping": {treatment: "X", outcome: "Y"}},
    )
