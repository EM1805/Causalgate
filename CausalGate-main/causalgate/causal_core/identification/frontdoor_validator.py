...
def install_frontdoor_mediator_validator(engine: Any) -> None:
    ...
    if getattr(IdentificationEngine, "_causalgate_step91_frontdoor_validator_installed", False):
        return
    ...
    IdentificationEngine._causalgate_step91_frontdoor_validator_installed = True
    IdentificationEngine._causalgate_step91_original_identify = original_identify
