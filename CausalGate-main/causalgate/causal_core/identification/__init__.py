...
def _patch_direct_confounding_failure_certificate_route() -> None:
    ...
    if getattr(IdentificationEngine, "_causalgate_step98_failure_route_installed", False):
        return
    ...
    IdentificationEngine._causalgate_step98_failure_route_installed = True
    IdentificationEngine._causalgate_step98_original_identify = original_identify
